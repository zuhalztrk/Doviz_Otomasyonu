...
namespace Doviz_Otomasyonu.Blazor.Server {
    public partial class Doviz_OtomasyonuBlazorApplication : BlazorApplication {
        public Doviz_OtomasyonuBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void Doviz_OtomasyonuBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
