...
using Doviz_Otomasyonu.Blazor.Server.Services;
...
namespace Doviz_Otomasyonu.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<Doviz_OtomasyonuBlazorApplication>(Configuration);
            ...
            services.AddXafSecurity(options => {
                ...
                options.UserType = typeof(Doviz_Otomasyonu.Module.BusinessObjects.ApplicationUser);
                // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                options.UserLoginInfoType = typeof(Doviz_Otomasyonu.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            services.AddSwaggerGen(c => {
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "Doviz_Otomasyonu API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the Doviz_Otomasyonu.Blazor.Server\Startup.cs file to make Business Objects available in Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if(env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Doviz_Otomasyonu WebApi v1");
                });
            }
            else {
